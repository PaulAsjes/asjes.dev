...
<section class="flex flex-col items-start justify-center max-w-5xl px-4 mx-auto sm:px-8 py-8 text-black dark:text-white">
  ...
  <div class="space-y-4">
    <p>
      Hello, I'm Paul Asjes. I work as a Developer Experience Engineer at WorkOS. I focus on raising awareness, being the voice of the developer and giving internal teams what they need to build great products.
    </p>
    <p>
      Prior to WorkOS I ran Developer Relations at Stripe. Before that I was a product engineer for 10+ years, working at Tumblr and various start ups over the years. I started my career as a Flash developer back in the stone age of the internet, now preferring to work in the JavaScript ecosystem.
    </p>
  </div>  
</section>
...
<section class="flex flex-col items-start justify-center max-w-5xl w-full px-4 mx-auto sm:px-8 py-8 text-black dark:text-white">
  ...
  <div class="m-4">
    ...
    <ul class="list-disc">
      ...
      <li><a href="https://vercel.com/" class="dark:text-blue-400">Vercel</a></li>
    </ul>  
  </div>
  ...
  <div class="m-4">    
    ...
    <ul class="list-disc">
      <li>VSCode (with <a href="https://draculatheme.com/visual-studio-code" class="dark:text-blue-400">Dracula</a> theme)</li>
      <li><a href="https://iterm2.com/" class="dark:text-blue-400">iTerm2</a></li>
      <li><a href="https://bear.app/" class="dark:text-blue-400">Bear notes</a></li>
    </ul>
  </div>
</section>